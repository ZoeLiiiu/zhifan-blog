...
('slow-work', '项目经验', '2026.07.12', '6 分钟', '把复杂的事，讲成别人听得懂的事', '好的表达不是把话说满，而是给对方一条可以走下去的路。', '我把这件事拆成三个动作：先说结论，再补关键证据，最后留下一个可执行的下一步。写文档、做汇报、和人协作，其实都适用。', 'mint', 'published', '2026-07-12T00:00:00.000Z', '2026-07-12T00:00:00.000Z', '2026-07-12T00:00:00.000Z'),
('small-launch', '项目经验', '2026.06.28', '8 分钟', '一个小功能上线后，我学会了先问为什么', '复盘不是寻找谁做错了，而是找出系统怎样才能更温柔地工作。', '这次上线最有价值的部分，不是交付了多少代码，而是让我们看见了需求、节奏和反馈之间的缝隙。下一次，我会把验证提前一周。', 'mint', 'published', '2026-06-28T00:00:00.000Z', '2026-06-28T00:00:00.000Z', '2026-06-28T00:00:00.000Z'),
